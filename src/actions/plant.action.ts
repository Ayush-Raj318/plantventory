...
async function getPlants(searchTerm?: string) {
  try {
...
async function createPlant(data: Prisma.PlantsCreateInput) {
...
export { getPlants, getPlantById, createPlant, editPlant, deletePlant };